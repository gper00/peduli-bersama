                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0">
                            <img src="{{ $donation->campaign->featured_image }}" alt="{{ $donation->campaign->title }}" class="w-24 h-24 object-cover rounded-md">
                        </div>
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">{{ Str::limit($donation->campaign->short_description, 100) }}</p>
                            <div class="mt-3 flex space-x-4">
                                <div>
                                    <span class="text-xs text-gray-500">Target</span>
                                    <p class="text-sm font-semibold">Rp {{ number_format($donation->campaign->target_amount, 0, ',', '.') }}</p>
                                </div>
                                <div>
                                    <span class="text-xs text-gray-500">Terkumpul</span>
                                    <p class="text-sm font-semibold">Rp {{ number_format($donation->campaign->current_amount, 0, ',', '.') }}</p>
                                </div>
                                <div>
                                    <span class="text-xs text-gray-500">Progress</span>
                                    <p class="text-sm font-semibold">{{ round(($donation->campaign->current_amount / $donation->campaign->target_amount) * 100) }}%</p>
                                </div>
                            </div>
                        </div>
                    </div>
