            ...
            <div class="p-6">
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <img src="{{ asset('storage/' . $donation->campaign->cover_image) }}" alt="{{ $donation->campaign->title }}" class="w-24 h-24 object-cover rounded-md mr-4">
                        @else
                        <div class="w-24 h-24 bg-gray-200 rounded-md mr-4"></div>
                        @endif
                        <div>
